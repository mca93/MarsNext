		...
		<div class="table-box card-base card-shadow--medium box grow" id="table-wrapper" v-loading="!asyncComponent">
			<div :style="{ 'width': width + 'px' }">
				...
				<component :is="asyncComponent" ref="table"
					...
					<v2-table-column label="Acc Number" prop="full_name" sortable width="200" align="left" :fixed="isMobile?'':'left'">
					...
					<v2-table-column label="Loc Ref" prop="email" sortable width="250">
						<template slot-scope="row">
							<span class="sel-string" v-html="$options.filters.selected(row.email, search)"></span>
						</template>
					</v2-table-column>
					<v2-table-column label="Loc Status" prop="gender" sortable></v2-table-column>
					<v2-table-column label="Regime" prop="job_title" sortable width="200"></v2-table-column>
					<v2-table-column label="Paid" prop="company" sortable width="120"></v2-table-column>
